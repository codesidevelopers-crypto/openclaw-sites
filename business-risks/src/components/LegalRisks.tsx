...
const cards = [
  ...
  },
  {
    ...
    desc: 'Следите за судебными событиями по вашей компании в реальном времени. Новые иски — сразу в уведомлении.',
    features: [
  ...
  <Section>
    <Container>
      <Header>
        ...
        <Subtitle>
          Три сервиса для тех, кому важно первым узнавать о проверках,
          судебных исках и исполнительных производствах — не когда уже поздно.
        </Subtitle>
      </Header>
      <Grid>
        {cards.map(c => (
